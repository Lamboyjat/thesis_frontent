...
export const Smcp = (props) => {

    const { textElement, translating, setTranslating, toLanguage, setToLanguage, generateTranslation } = props
  return (
    <>
        ...
        {!translating && (<div className='flex flex-col gap-1 mb-4'>
            ...
            <div className='flex items-stretch gap-2 sm:gap-4' >
                ...
                <button onClick={generateTranslation} className='specialBtn px-3 py-2 rounded-lg text-blue-400 hover:text-blue-600 duration-200'>To SMCP</button>
            </div>
        </div>)}
    </>
  )
